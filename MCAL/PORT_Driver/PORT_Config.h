...
#define PORTB_PIN0_DIR   INIT_INPUT
#define PORTB_PIN1_DIR   INIT_INPUT
#define PORTB_PIN2_DIR   INIT_INPUT
#define PORTB_PIN3_DIR   INIT_INPUT
#define PORTB_PIN4_DIR   INIT_INPUT
#define PORTB_PIN5_DIR   INIT_INPUT
#define PORTB_PIN6_DIR   INIT_INPUT
 ...
 *
 */
#define PORTA_PIN0_INITAIL_VALUE  INIT_LOW
#define PORTA_PIN1_INITAIL_VALUE  INIT_LOW
#define PORTA_PIN2_INITAIL_VALUE  INIT_LOW
#define PORTA_PIN3_INITAIL_VALUE  INIT_LOW
...
#define PORTB_PIN0_INITAIL_VALUE  INIT_NORMAL_IN
#define PORTB_PIN1_INITAIL_VALUE  INIT_NORMAL_IN
#define PORTB_PIN2_INITAIL_VALUE  INIT_PULL_UP
#define PORTB_PIN3_INITAIL_VALUE  INIT_NORMAL_IN
#define PORTB_PIN4_INITAIL_VALUE  INIT_NORMAL_IN
#define PORTB_PIN5_INITAIL_VALUE  INIT_NORMAL_IN
#define PORTB_PIN6_INITAIL_VALUE  INIT_NORMAL_IN
#define PORTB_PIN7_INITAIL_VALUE  INIT_NORMAL_IN
...
#define PORTD_PIN3_INITAIL_VALUE  INIT_PULL_UP
